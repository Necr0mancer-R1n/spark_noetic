...
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Collection_A${Font_color_suffix}"

echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}Step_NW${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Step_NW'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Step_NW${Font_color_suffix}"
...
echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}Step_SW${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Step_SW'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Step_SW${Font_color_suffix}"
...
echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}Step_SE${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Step_SE'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Step_SE${Font_color_suffix}"
...
echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}Step_NE${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Step_NE'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Step_NE${Font_color_suffix}"
...
echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}分拣区中北${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Sorting_M'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Sorting_M${Font_color_suffix}"

echo -e ""
echo -e "${Info} 控制 spark 移动到 ${Yellow_background_prefix}分拣区中南${Font_color_suffix}\c"
echo && stty erase '^H' && read -p "       然后在这个界面内按回车..." 
rostopic pub /mark_nav std_msgs/String "data: 'learn Sorting_MS'" -1 >/dev/null
echo -e "${Info} 地点名为 ${Yellow_background_prefix}Sorting_M${Font_color_suffix}"
